...
class Ui_TapeDriveWindow(object):
    def setupUi(self, TapeDriveWindow):
        ...
        self.btnM1bw.setStyleSheet("QPushButton {background-color: rgba(0,0,0,0.5)}")
        ...
        self.btnM1fw.setStyleSheet("QPushButton {background-color: rgba(0,0,0,0.5)}")
        ...
        self.btnM2bw.setStyleSheet("QPushButton {background-color: rgba(0,0,0,0.5)}")
        ...
        self.btnM2fw.setStyleSheet("QPushButton {background-color: rgba(0,0,0,0.5)}")
        ...
        self.btnForward.setGeometry(QtCore.QRect(150, 260, 101, 61))
        self.btnForward.setStyleSheet("QPushButton {background-color: rgba(0,0,0,0.5);}")
        self.btnForward.setText("")
        self.btnForward.setIcon(icon1)
        self.btnForward.setIconSize(QtCore.QSize(75, 75))
        self.btnForward.setObjectName("btnForward")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(250, 220, 101, 121))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.btnHome = QtWidgets.QPushButton(self.groupBox)
        self.btnHome.setEnabled(False)
        self.btnHome.setGeometry(QtCore.QRect(10, 30, 80, 80))
        ...
        self.homeEnable.setGeometry(QtCore.QRect(17, 10, 71, 21))
        ...
        self.btnBackward.setGeometry(QtCore.QRect(40, 260, 101, 61))
        self.btnBackward.setStyleSheet("QPushButton {background-color: rgba(0,0,0,0.5)}")
        self.btnBackward.setText("")
        self.btnBackward.setIcon(icon)
        self.btnBackward.setIconSize(QtCore.QSize(75, 75))
